          ...
          >
            <div className="photo-outer" style={{
              ...
              {/* protected-image-wrap adds a transparent overlay above the
                  photo so right-click/drag/long-press can't reach it directly.
                  The photo itself is rendered as a CSS background-image
                  (not an <img> tag) so browser "Reader Mode" / content
                  distillation tools — which only pull real <img>/<picture>
                  elements — don't pick it up either. */}
              <div className="protected-image-wrap">
                <div
                  role="img"
                  aria-label="Vusala Huseynova"
                  ...
                  style={{
                    ...
                    width: "100%",
                    height: "100%",
                    backgroundImage: "url('/vusala.jpeg')",
