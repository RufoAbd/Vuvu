...
function FeaturedProject({
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            opacity: project.image ? 0.55 : 0.7,
      ...
      >
        {/* Mobile-only background image: lives inside the SAME card as the text */}
        {project.image && (
          <div
            className="featured-img-bg-mobile"
            style={{
              display: "none",
              position: "absolute",
              inset: 0,
        ...
        <div
          className="featured-overlay-mobile"
          style={{
            display: "none",
            position: "absolute",
            inset: 0,
